...
public class HotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        latestTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(HotActivity.this, LatestNews.class);
        ...
        typeTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HotActivity.this, AllTypeActivity.class);
                startActivity(intent);
                overridePendingTransition(0,0);
            }
        });
        ...
        final Handler handler = new Handler() {
            ...
            public void handleMessage(@NonNull Message msg) {
                ...
                LinearLayoutManager layoutManager = new LinearLayoutManager(HotActivity.this);
        ...
        new Thread() {
            ...
            public void run() {
                ...
                List<News_User> list = new ArrayList<>();
                try {
                    list = News_UserDao.selectNews_UserForHot();
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    class MyAdapter extends RecyclerView.Adapter<MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            //引入布局文件
            View view = LayoutInflater.from(HotActivity.this).inflate(R.layout.list_item_news, parent, false);
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            holder.list_news_itemLinearLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(HotActivity.this, NewsContentActivity.class);
                    //Intent 传参
